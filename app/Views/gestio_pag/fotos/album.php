                    ...
                    <div class="album-card">
                        <div class="w3-card-4">
                            ...
                            <div class="w3-bar w3-margin-bottom w3-margin-left">
                                <a href="<?= base_url('gestio/galeria/modify/' . $album['id']) ?>" class="w3-bar-item w3-button w3-blue w3-margin-right">
                                    <i class="fas fa-edit"></i> Modificar album
                                </a>
                                <a href="<?= base_url('gestio/galeria/eliminarAlbum/' . $album['id']) ?>" class="w3-bar-item w3-button w3-red" onclick="return confirm('Vols eliminar aquest album?');">
                                    <i class="fas fa-trash-alt"></i> Eliminar album
                                </a>
                            </div>
                        </div>
                    </div>
