...
<?php if (session()->has('errors')): ?>
    ...
    <form action="<?= base_url('gestio/clubs/add')?>" method="POST" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border" type="text" id="nom" name="nom" value="<?= old('nom') ?>">
        </div>
        <div class="w3-section">
            <label for="foto" class="w3-text-blue"><b>Foto del club:</b></label>
            <input class="w3-input w3-border" type="text" id="foto" name="foto" value="<?= old('foto') ?>" readonly>
